...
public class Edge extends GPProblem implements SimpleProblemForm {
    ...
    public String printCurrentNFA() {
        ...
        for (int x = 0; x < numNodes; x++) {
            str.append(justify(String.valueOf(x), strsize, J_RIGHT)).append(" ").append(start[x] ? "S" : " ").append(accept[x] ? "A" : " ").append(" -> ");

            if (reading0_l[x] > 0) {
                str.append("(0:");
                for (int y = 0; y < reading0_l[x]; y++)
                    str.append(y > 0 ? "," : "").append(reading0[x][y]);
                str.append(") ");
            }
            ...
            if (reading1_l[x] > 0) {
                ...
                for (int y = 0; y < reading1_l[x]; y++)
                    str.append(y > 0 ? "," : "").append(reading1[x][y]);
                str.append(") ");
            }
            ...
            if (epsilon_l[x] > 0) {
                ...
                for (int y = 0; y < epsilon_l[x]; y++)
                    str.append(y > 0 ? "," : "").append(epsilon[x][y]);
                str.append(")");
            }
            str.append("\n");
        }

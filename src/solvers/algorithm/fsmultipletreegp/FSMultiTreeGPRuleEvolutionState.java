package solvers.algorithm.fsmultipletreegp;
    ...
    public int evolve() {
        ...
        if (generation == preGenerations) {
            ...
            for (int i = 0; i < 2; i++) { //before here is ++i
                ...
                double fitUB = selIndis.get(0).fitness.fitness();  //the upper bound of fitness  the smallest one 0.75
                double fitLB = 1 - fitUB;  //the lower bound of fitness   0.25

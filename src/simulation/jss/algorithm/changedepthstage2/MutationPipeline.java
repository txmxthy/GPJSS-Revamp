...
public class MutationPipeline extends GPBreedingPipeline
    ...
    public boolean verifyPoints(GPNode inner1, GPNode inner2, EvolutionState state)
        {
    ...
    public int produce(final int min,
        ...
        for(int q=start; q < n+start; q++) //q=start = 0  q<1
            ...
            for(int x=0;x<numTries;x++)
                ...
                res = verifyPoints(p2,p1,state);  // p2 can fit in p1's spot  -- the order is important!

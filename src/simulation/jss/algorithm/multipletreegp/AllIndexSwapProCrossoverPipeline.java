package simulation.jss.algorithm.multipletreegp;
 ...
 */
public class AllIndexSwapProCrossoverPipeline extends CrossoverPipeline {
    /**
	...
	//after that, according to probability to decide whether to swap the other tree. 
          ...
          //  System.out.println(parents[1].trees.length);
            ...
            for(int x=0;x<j1.trees.length;x++)
                ...
                if (x==t1 && res1)  // we've got a tree with a kicking cross position!
                	...
                	//after that, whether to swap the other tree depends on the probability. 

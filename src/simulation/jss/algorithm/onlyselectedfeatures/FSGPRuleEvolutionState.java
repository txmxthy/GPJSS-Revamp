...
import static simulation.jss.feature.FeatureUtil.ruleTypes;
...
//            //for niching
   ...
   //fzhang 2019.6.26 adapt individuals based on selected individuals by clustering
    public void adaptPopulationWithClustering(List<GPIndividual> individuals, int subPopNum){
        ...
        } else if (evaluator instanceof simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator) {
            simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator clearingEvaluator =
                    (simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator) evaluator;
            pc = clearingEvaluator.getPhenoCharacterisation()[subPopNum];
        }

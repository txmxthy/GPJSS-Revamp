...
import simulation.jss.gp.terminal.BuildingBlock;
...
public class FeatureUtil {
    ...
    public static List<GPIndividual> selectDiverseIndis(EvolutionState state, Individual[] archive,
        ...
        } else if (state.evaluator instanceof simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator) {
            simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator clearingEvaluator =
                    (simulation.jss.niching.MultiPopCoevolutionaryClearingEvaluator) state.evaluator;
